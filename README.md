# EDA Personal Projects

**Version**: 1.0
**Author**: @pahoalapizco


Exploratory Data Analysis projects to improve skills like: data manipulation, missing values analysis, data visualization and so on.
...
activate eda_personal_projects
```
